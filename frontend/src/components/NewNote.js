    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            <div className='flex w-full justify-center'>
                <button onClick={handleUpload} className="flex w-4/5 justify-center overflow-hidden bg-slate-500 hover:bg-slate-700 py-2 px-4 rounded" >
            ...
            <div className='flex w-full justify-center'>
                <input onChange={handleFile} className="w-4/5 block text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file" />
            </div>
        </div>
    );
}